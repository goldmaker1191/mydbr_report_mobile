...
jQuery(document).ready(function($) {
	...
	$(topFilters).on('click', '.handler', function(event) {
		...
		$(".divTableWithFloatingHeader .divTableWithFloatingHeader").customScrollbar("scrollToY", 0);
		$("body").find("#thead_clone").toggle();
	});

	//Generating Column Buttons
	$("body").find(".tableFloatingHeaderOriginal:eq(1) .row_header th").each(function(index, el) {
		$(topFilters).append('<button data-col="'+(index+1)+'" class="col_hide">'+$(this).text()+'</button>');
	});

	//Filters initial position
	$(topFilters).css("top", "-" + $(topFilters).height()-25 + "px");
	...
	$("body").append('<div id="thead_clone"><div class="inner"></div></div>');
	var theadClone = $("body").find("#thead_clone");

	//Generating Duplicate Fixed Table Headers
	$("body").find(".tableFloatingHeaderOriginal:eq(1) .row_header th").each(function(index, el) {
		$(".inner", theadClone).append('<div data-col="'+(index+1)+'" class="" style="width:'+$(this).width()+'px">'+$(this).text()+'</div>');
	});
	...
	function refreshSize() {
		...
		//Top Search Size
		$("#tab_dbr_rt1").width(screenWidth-40 + "px");

		//Table Header Resizing 
		$(".inner", theadClone).width($(".tableFloatingHeaderOriginal:eq(1) .row_header").width() + "px");
		$(".inner", theadClone).height($(".tableFloatingHeaderOriginal:eq(1) .row_header").height() + "px")
		$(".tableFloatingHeaderOriginal:eq(1) .row_header").height($(".inner", theadClone).height() + "px");
		$(theadClone).height($(".tableFloatingHeaderOriginal:eq(1) .row_header").height() + "px");

		//Managing Clone Header Size according to Table Header
		$("body").find(".tableFloatingHeaderOriginal:eq(1) .row_header th").each(function(index, el) {
			$(".inner div:eq("+index+")", theadClone).width($(this).width()+'px');
		});
	...
	function refreshScrollbar() {
		$(".divTableWithFloatingHeader .divTableWithFloatingHeader").customScrollbar("resize", true);
	}
	...
	setTimeout(function() {
		$(".divTableWithFloatingHeader .divTableWithFloatingHeader").customScrollbar({
	...
	$("body").on('click', '#rightScroller', function(event) {
		$(".divTableWithFloatingHeader .divTableWithFloatingHeader").customScrollbar("scrollByX", 200);
		setTimeout(function() {
			$(".inner", theadClone).css("left", $("body").find(".overview").css("left"));
		}, 300);
	});
	...
	$("body").on('click', '#topScroller', function(event) {
		$(".divTableWithFloatingHeader .divTableWithFloatingHeader").customScrollbar("scrollByY", 200);
	});
